...
namespace LAB.Controllers
{
    public class 客戶銀行資訊Controller : Controller
    {
        ...
        {
            var 客戶銀行資訊 = db.客戶銀行資訊.Include(客 => 客.客戶資料).Where(c => !c.是否已刪除 && !c.客戶資料.是否已刪除);
        ...
        public ActionResult List(string input)
        {
            ...
            var data = db.客戶銀行資訊.Include(客 => 客.客戶資料)
                .Where(c => !c.是否已刪除 && !c.客戶資料.是否已刪除)
                .Where(c => c.銀行名稱.Contains(input) ||
                            c.銀行代碼.ToString().Contains(input) ||
                            c.分行代碼.ToString().Contains(input) ||
                            c.帳戶名稱.Contains(input) ||
                            c.帳戶號碼.Contains(input));
